...
//die($_SESSION['6_letters_code']);
	...
	// strcmp()
		  echo '<script type="text/javascript">window.location = "/status/general-inquiry-form/error/"</script>';
	exit;} 
...
echo '<script type="text/javascript">window.location = "/status/general-inquiry-form/success/"</script>';
