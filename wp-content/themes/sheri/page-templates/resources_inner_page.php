<?php
/**
 * Template Name: Resources Single Page
 *
...
for ($x = 0; $x < count($pages); $x++) {
	...
	$attached_link = get_field( "link", $pages[$x]->ID ); 
...
if(($x+1) % 4 == 0) {
echo '<div class="resources_icon">';

echo '<div class="header"><a href="'.$attached_link.'" target="_blank"><img src="'.$featured_icon[0].'"></div>';
echo  '<div class="title">'. $pages[$x]->post_title .'</div></a>';
