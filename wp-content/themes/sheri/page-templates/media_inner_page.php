<?php
/**
 * Template Name: Media Single Page
 *
...
for ($x = 0; $x < count($pages); $x++) {
	...
	$attached_pdf = get_field( "pdf", $pages[$x]->ID ); 
...
echo '<div class="header"><a href="'.$attached_pdf.'" target="_blank"><img src="'.$featured_icon[0].'"></div>';
